...
```{r start, eval = FALSE}
Sys.setenv("JAVA_HOME" = "your_path") 
```
...
```{r Default, fig.width=10, fig.height=4.5, fig.align = 'center'}
result0 <- dsa(series)
result0
plot(result0)
```
...
```{r output, fig.width=10, fig.height=4.5, eval = FALSE}
...
```{r DefaultRegs, fig.width=10, fig.height=4.5, fig.align = 'center'}
result <- dsa(series,
              xreg = regs)
result
plot(result)
...
```{r AdjustmentMissing, fig.width=10, fig.height=4.5, fig.align = 'center'}
seriesx <- series
...
```{r, AdjustmentX11, fig.width=10, fig.height=4.5, fig.align = 'center'}
result2 <-  dsa(series, 
                s7 = "x11",
...
```{r SeatsAdjustment, fig.width=10, fig.height=4.5, fig.align = 'center'}
result3 <- dsa(series, 
               s7 = seats_method(),
               s365 = seats_method(), 
               log = FALSE,
...
```{r DayOfMonth, fig.width=10, fig.height=4.5, fig.align = 'center'}
