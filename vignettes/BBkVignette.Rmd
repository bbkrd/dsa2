...
To get started, ensure that you have Java 17 oder higher. If not automatically detected, 
...
**In the Bundesbank, you can get Java 17 here:** 
...
```{r output, fig.width=7.5, fig.height=4.5, eval = FALSE}
output(result0) # Create HTML output
```
...
```{r DayOfMonth, fig.width=7.5, fig.height=4.5}
